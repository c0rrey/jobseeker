...
3. The compensation signals (if visible) do not clearly fall below ${{ salary_target }} USD. *(soft threshold — uncertain or missing comp does not trigger a NO)*
...
- The compensation is explicitly listed below ${{ salary_min }} USD. *(hard floor — explicit listing below this value is an immediate NO)*
